    ...
    return(<>
            <section className="flex flex-col items-center justify-center w-full h-full px-8 pt-10 overflow-hidden shadow-xl md:pb-20 md:pt-20 md:gap-2 md:px-28">
                ...
                <div className="flex justify-center w-full p-5 my-4 border border-purple-700 md:gap-2 md:p-10 bg-purple-950 bg-opacity-20 rounded-2xl">
                    <FontAwesomeIcon icon={faPaperPlane} className="w-4 h-4 p-2 mt-2 text-white border border-purple-500 rounded-full md:p-4 md:h-8 md:w-8 bg-purple-950"/>
                    <div className="flex flex-col font-mono text-left text-white">
                        ...
                        <p className="flex flex-col gap-2 pb-2 text-xs font-normal text-center md:flex-row md:justify-between md:text-left md:text-xl">Let's build something amazing together! <LetsConnectButton /> </p>
                    </div>
                </div>
            </section>
        </>)
